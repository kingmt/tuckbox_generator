...
measurements[:widths][:left_side_flap_indent] = measurements[:thickness_in_points] + EIGHTH_INCH
measurements[:widths][:right_side_flap_cut] = measurements[:thickness_in_points] + measurements[:width_in_points] - QUARTER_INCH
measurements[:widths][:right_side_flap_indent] = measurements[:thickness_in_points] + measurements[:width_in_points] - EIGHTH_INCH
...
measurements[:widths][:reverse_left_side_flap_indent] = bounding_box_width - measurements[:thickness_in_points] - EIGHTH_INCH
measurements[:widths][:reverse_right_side_flap_indent] = bounding_box_width - measurements[:thickness_in_points] - measurements[:width_in_points] + EIGHTH_INCH
...
measurements[:points][14] = measurements[:widths][:left_side_flap_indent], measurements[:heights][:top_of_tuck_flap]
measurements[:points][15] = measurements[:widths][:left_side_flap_cut], measurements[:heights][:top_of_top_face]
measurements[:points][16] = measurements[:widths][:right_side_flap_indent], measurements[:heights][:top_of_tuck_flap]
...
measurements[:points][50] = measurements[:widths][:left_side_flap_indent],   measurements[:heights][:bottom_of_bottom_tuck_flap]
measurements[:points][51] = measurements[:widths][:right_side_flap_indent],  measurements[:heights][:bottom_of_bottom_tuck_flap]
...
measurements[:reverse_points][14] = measurements[:widths][:reverse_left_side_flap_indent], measurements[:heights][:top_of_tuck_flap]
measurements[:reverse_points][15] = measurements[:widths][:reverse_left_side_flap_cut], measurements[:heights][:top_of_top_face]
measurements[:reverse_points][16] = measurements[:widths][:reverse_right_side_flap_indent], measurements[:heights][:top_of_tuck_flap]
...
measurements[:reverse_points][50] = measurements[:widths][:reverse_left_side_flap_indent],   measurements[:heights][:bottom_of_bottom_tuck_flap]
measurements[:reverse_points][51] = measurements[:widths][:reverse_right_side_flap_indent],  measurements[:heights][:bottom_of_bottom_tuck_flap]
